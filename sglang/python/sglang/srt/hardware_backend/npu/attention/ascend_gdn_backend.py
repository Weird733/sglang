...
class AscendGDNAttnBackend(AscendMambaAttnBackendBase):
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        # v2: conv_state stays channels-last (..., state_len, dim), so use its
        # native shape without swapping the last two dims.
    ...
    def forward_decode(
        ...
        **kwargs,
        ...
        # v2: causal_conv1d_update_npu consumes channels-last conv_state directly,
        # so no transpose clone / write-back is needed.
    ...
    def forward_extend(
        ...
        **kwargs,
        ...
        # is_target_verify is set to False while rollout
